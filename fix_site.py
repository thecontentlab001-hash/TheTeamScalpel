...
LANGUAGE_REPLACEMENTS = {
    ...
    'à®¤à®®à®¿à®´à¯ ': 'தமிழ்',
    'à°¤±†à°²à± à°—à± ': 'తెలుగు',
    'à°¤±\u0086à°²à±\u0081à°—à±\u0081': 'తెలుగు', # Handle variants
    'à¤®à¤°à¤¾à¤ à¥€': 'मराठी',
...
def fix_file(filename):
    ...
    # 1. Fix Language Replacements
    for mangled, correct in LANGUAGE_REPLACEMENTS.items():
        content = content.replace(mangled, correct)

    # 2. Rename custom .fab to .fab-btn in containers
    # Target: <button class="fab ..."> and <a class="fab ...">
    # Note: We must NOT replace <i class="fab ..."> as those are Font Awesome icons.
    
    # Regex to match class="fab " or class="fab" on button/a tags
    ...
    # Specific fix for the fab-chat-toggle id just in case
